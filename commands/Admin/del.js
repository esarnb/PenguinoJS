exports.run = async (client, msg, args) => {
    ...
    else if (msg.guild && !msg.guild.members.cache.get(client.user.id).permissionsIn(msg.channel).has("MANAGE_MESSAGES", true)) return msg.channel.send("I do not have perms to edit messages.")
